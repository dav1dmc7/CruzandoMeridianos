...
console.log("✓ Auditoría P0/P1 preparada para aplicar localmente.");
console.log("→ Ejecuta: node scripts/apply-audit-hardening.mjs");
console.log("→ Después: npx astro check && npm run build && git diff --check");
